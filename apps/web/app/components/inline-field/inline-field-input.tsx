...
export const InlineFieldInput = genericForwardRef<
  React.ElementRef<"input">,
  UIComponentProps<"input">
>(function InlineFieldInput(props, ref) {
  return (
    <div className="relative size-4">
        ...
        className={clsx(
          "peer absolute inset-0 size-full appearance-none border border-gray-300 bg-white outline-hidden transition-all",
          {
            [clsx(
              ...
              "indeterminate:border-blue-600 indeterminate:bg-blue-600 indeterminate:hover:border-blue-600 indeterminate:hover:bg-blue-600",
      ...
      <div
        className={clsx({
          [clsx(
            ...
            "group peer-checked:opacity-100 peer-indeterminate:opacity-100 peer-disabled:text-white",
          )]: props.type === "checkbox",
          [clsx(
      ...
      >
        {props.type === "checkbox" ? (
          <>
            <IconCheck className="stroke-1.5 size-3 group-[.peer:indeterminate_~_&]:hidden" />
            <IconMinus className="stroke-1.5 hidden size-3 group-[.peer:indeterminate_~_&]:block" />
          </>
        ) : undefined}
      </div>
    </div>
