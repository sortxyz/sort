...
function Menu() {
  ...
  const loaderData = useRouteLoaderData<typeof loader>(
    "routes/orgs/$org_slug/databases/$database_slug/change-requests/$change_request_number/explorer/schemas.$schema_name.tables",
  );
    ...
    <GlobalSidebarMenu>
      {databaseLoaderData ? (
        <GlobalSidebarMenuNavLinkItem
          ...
          title={`Change Request #${params.change_request_number}`}
          to={`/orgs/${params.org_slug}/databases/${params.database_slug}/change-requests/${params.change_request_number}`}
        >
          Change Request #{params.change_request_number}
        </GlobalSidebarMenuNavLinkItem>
      ) : undefined}
      <GlobalSidebarMenuNavLinkItem
        iconLeft={<IconDatabaseSearch className="stroke-1.5 size-6" />}
        title="Data Explorer"
        to={`/orgs/${params.org_slug}/databases/${params.database_slug}/change-requests/${params.change_request_number}/explorer/schemas/${params.schema_name}/tables/${params.table_name}`}
      >
        Data Explorer
      </GlobalSidebarMenuNavLinkItem>
      <header
      ...
      >
        <Form
          action={`/orgs/${params.org_slug}/databases/${params.database_slug}/change-requests/${params.change_request_number}/explorer/schemas/${params.schema_name}/tables/${params.table_name}`}
        >
          <Field fullWidth>
            <FieldInput
              autoCapitalize="none"
      ...
      >
        ...
        {loaderData?.tables.map((table) => (
          <li className="block" key={table.id}>
            <NavLink
              to={`/orgs/${params.org_slug}/databases/${params.database_slug}/change-requests/${params.change_request_number}/explorer/schemas/${params.schema_name}/tables/${table.name}`}
              className={clsx(
      ...
      {loaderData?.schemas && loaderData.schemas.length > 1 ? (
        <ActionForm
          ...
          action={`/orgs/${params.org_slug}/databases/${params.database_slug}/change-requests/${params.change_request_number}/explorer/schemas/${params.schema_name}/tables`}
        >
          <Field
            fullWidth
...
export async function loader({ request, params }: LoaderFunctionArgs) {
  ...
  if (
    ...
    throw redirectDocument(
      `/orgs/${params.org_slug}/databases/${params.database_slug}/change-requests/${params.change_request_number}/explorer/schemas/${params.schema_name}/tables/${firstTable.name}`,
      {
  ...
  switch (intent) {
    case "change-schema": {
      ...
      if (typeof schema_name !== "string") {
        throw redirect(
          `/orgs/${params.org_slug}/databases/${params.database_slug}/change-requests/${params.change_request_number}/explorer/schemas/${params.schema_name}/tables`,
        );
      }

      throw redirectDocument(
        `/orgs/${params.org_slug}/databases/${params.database_slug}/change-requests/${params.change_request_number}/explorer/schemas/${schema_name}/tables`,
      );
    }
    default: {
